...
K=0.9;  % noise standard deviation
...
drawnow;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TEST 5 - Gaussian blurring

K=0.00000001;  % noise standard deviation
...
Iinv=wiener_deblur(I,B,0.1*K);     % <--- I have used a more optimistic value here
...
B = fspecial('disk',9);
%Ib= noisy_image(blur_image(I,B),K);
Iinv=wiener_deblur(I,B,0.1*K); % <--- I have again used a more optimistic value here
figure;
colormap(gray);
subplot(1,7,[1 2]);
imagesc(I); axis equal tight; caxis([0 1]);
